...
export default function CoC() {
  return (
    <main className="wrapper pb-6 [&_p]:text-sm [&_li]:text-sm [&_h2]:text-4xl [&_h4]:text-2xl">
      <h1 className="text-center text-5xl p-3 m-3 uppercase font-light">
        Code of Conduct
      </h1>
      ...
      <article className="">
        {/* SCOPE */}
        <div className="my-6">
          <h2 className="text-3xl uppercase font-light pb-2">Scope</h2>
          <p>{CoC_Contents.SCOPE_TEXT}</p>
        </div>

        {/* ENFORCEMENT */}
        <div className="my-6">
          <h2 className="text-3xl uppercase font-light pb-2">Enforcement</h2>
        ...
        <div className="my-6">
          <h2 className="text-3xl uppercase font-light pb-2">
            Unacceptable Behavior
          </h2>
          <ul>
